...
3. [x] [3. This unary operator, known as the address operator, makes a pointer to a variable in Objective-C. ](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#3-this-unary-operator-known-as-the-address-operator-makes-a-pointer-to-a-variable-in-objective-c-)
4. [x] [4. Addresses](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#4-addresses)
5. [x] [5. console output Addresses](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#5-console-output-addresses)
6. [x] [6. In a computer, everything is stored in memory, and thus everything has an address. ](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#6-in-a-computer-everything-is-stored-in-memory-and-thus-everything-has-an-address-)
7. [x] [7. Console output](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#7-console-output)
8. [x] [8. Getting addresses.](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#8-getting-addresses)
9. [x] [9. Use the * operator on the left-hand side of an assignment to store data at a particular address:](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#9-use-the--operator-on-the-left-hand-side-of-an-assignment-to-store-data-at-a-particular-address)
10. [x] [10. Storing addresses in pointers.](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#10-storing-addresses-in-pointers)
11. [x] [11. Getting the data at an address.](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#11-getting-the-data-at-an-address)
12. [x] [12. How many bytes does this data type occupy ?](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#12-how-many-bytes-does-this-data-type-occupy-)
13. [x] [13. NULL](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#13-null)
14. [x] [14. another example](https://github.com/c4arl0s/8AddressesAndPointers-ObjectiveC#14-another-example)
...
3. [x] [3. Programmers often use the word buffer to mean a long line of bytes of memory.](https://github.com/c4arl0s/11TheHeap#3-programmers-often-use-the-word-buffer-to-mean-a-long-line-of-bytes-of-memory)
4. [x] [4. You claim a buffer of memory using the function **malloc()**.](https://github.com/c4arl0s/11TheHeap#4-you-claim-a-buffer-of-memory-using-the-function-malloc)
5. [x] [5. When you’re done using the buffer, you call the function free() ](https://github.com/c4arl0s/11TheHeap#5-when-youre-done-using-the-buffer-you-call-the-function-free-)
6. [x] [6. We need a chunk of memory big enough to hold 1,000 floats.](https://github.com/c4arl0s/11TheHeap#6-we-need-a-chunk-of-memory-big-enough-to-hold-1000-floats)
...
3. [x] [3. Objects in memory](https://github.com/c4arl0s/12Objects-ObjectiveC#3-objects-in-memory)
...
3. [x] [3. Dot notation](https://github.com/c4arl0s/17YourFirstClass-ObjectiveC/blob/master/README.md#3-dot-notation)
4. [x] [4. Properties](https://github.com/c4arl0s/17YourFirstClass-ObjectiveC/blob/master/README.md#4-properties)
5. [x] [5. self](https://github.com/c4arl0s/17YourFirstClass-ObjectiveC/blob/master/README.md#5-self)
...
3. [x] [3. Zeroing of Weak references](https://github.com/c4arl0s/20PreventingMemoryLeaks-ObjectiveC#3-zeroing-of-weaks-references)
4. [x] [4. Manual Reference Counting and ARC History](https://github.com/c4arl0s/20PreventingMemoryLeaks-ObjectiveC#4manual-reference-counting-and-arc-history)
...
3. [x] [3. Sorting](https://github.com/c4arl0s/21CollectionClasses-ObjectiveC#3-sorting)
4. [x] [4. Filtering](https://github.com/c4arl0s/21CollectionClasses-ObjectiveC#4-filtering)
5. [x] [5. NSSet/NSMutableSet](https://github.com/c4arl0s/21CollectionClasses-ObjectiveC#5-nssetnsmutableset)
6. [x] [6. NSDictionary/NSMutableDictionary](https://github.com/c4arl0s/21CollectionClasses-ObjectiveC#6-nsdictionarynsmutabledictionary)
...
3. [x] [3. #define](https://github.com/c4arl0s/22Constants-ObjectiveC#3-define)
4. [x] [4. Global Variables](https://github.com/c4arl0s/22Constants-ObjectiveC#4-global-variables)
...
3. [x] [3. Reading files with NSString](https://github.com/c4arl0s/23WritingFilesWithNSStringAndNSData-ObjectiveC#3-reading-files-with-nsstring)
...
3. [x] [3. Notifications](https://github.com/c4arl0s/24Callbacks-ObjectiveC#3-notifications)
...
3. [x] [3. The class of an object is different from its role in a working system.](https://github.com/c4arl0s/25Protocols-ObjectiveC/blob/master/README.md#3-the-class-of-an-object-is-different-from-its-role-in-a-working-system)
4. [x] [4. We’ve talked about how to specify a class. Is it possible to specify a role?](https://github.com/c4arl0s/25Protocols-ObjectiveC/blob/master/README.md#4-weve-talked-about-how-to-specify-a-class-is-it-possible-to-specify-a-role)
5. [x] [5. How did the developer who created the UITableView class specify the role of UITableView’s data source? He created a protocol.](https://github.com/c4arl0s/25Protocols-ObjectiveC/blob/master/README.md#5-how-did-the-developer-who-created-the-uitableview-class-specify-the-role-of-uitableviews-data-source-he-created-a-protocol) 
6. [x] [6. A protocol is a list of method declarations.](https://github.com/c4arl0s/25Protocols-ObjectiveC/blob/master/README.md#6-a-protocol-is-a-list-of-method-declarations)
...
1. [x] [1. 27YourFirstiOSApplication](https://github.com/c4arl0s/27YourFirstiOSApplication#1-27yourfirstiosapplication)
2. [x] [2. The run loop waits for events](https://github.com/c4arl0s/27YourFirstiOSApplication#2-the-run-loop-waits-for-events)
3. [x] [3. Model View Controller](https://github.com/c4arl0s/27YourFirstiOSApplication#3-model-view-controller)
4. [x] [4. The UIApplication Object](https://github.com/c4arl0s/27YourFirstiOSApplication#4-the-uiapplication-object)
5. [x] [5. The application delegate](https://github.com/c4arl0s/27YourFirstiOSApplication#5-the-application-delegate)
6. [x] [6. Watch out about this after continue with the project](https://github.com/c4arl0s/27YourFirstiOSApplication#6-watch-out-about-this-after-continue-with-the-project)
7. [x] [7. AppDelegate.h](https://github.com/c4arl0s/27YourFirstiOSApplication#7-appdelegateh)
8. [x] [8. AppDelegate.m](https://github.com/c4arl0s/27YourFirstiOSApplication#8-appdelegatem)
9. [x] [9. pragma mark - Application Delegate callbacks](https://github.com/c4arl0s/27YourFirstiOSApplication#9-pragma-mark---application-delegate-callbacks)
10. [x] [10. iOS Documentation: Responding to Notifications and Events](https://github.com/c4arl0s/27YourFirstiOSApplication#10-ios-documentation-responding-to-notifications-and-events)
11. [x] [11. Setting up the Views](https://github.com/c4arl0s/27YourFirstiOSApplication#11-setting-up-the-views)
12. [x] [12. Running on the iOS Simulator](https://github.com/c4arl0s/27YourFirstiOSApplication#12-running-on-the-ios-simulator)
13. [x] [13. Adding new tasks](https://github.com/c4arl0s/27YourFirstiOSApplication#13-adding-new-tasks)
14. [x] [14. Saving task data](https://github.com/c4arl0s/27YourFirstiOSApplication#14-saving-task-data)
15. [x] [15.  What is the first responder bussines ?](https://github.com/c4arl0s/27YourFirstiOSApplication#15-what-is-the-first-responder-bussines-)
16. [x] [16. Fix object sizes](https://github.com/c4arl0s/27YourFirstiOSApplication#16-fix-object-sizes)
...
3. [x] [3. Using accessors](https://github.com/c4arl0s/29init-ObjectiveC#3-using-accessors)
...
3. [x] [3. Lifetime specifiers](https://github.com/c4arl0s/30Properties_ObjectiveC#3-lifetime-specifiers)
4. [x] [4. copy](https://github.com/c4arl0s/30Properties_ObjectiveC#4-copy)
5. [x] [5. More about copying](https://github.com/c4arl0s/30Properties_ObjectiveC#5-more-about-copying)
6. [x] [6. Advice on atomic vs. nonatomic](https://github.com/c4arl0s/30Properties_ObjectiveC#6-advice-on-atomic-vs-nonatomic)
...
3. [x] [3. Using blocks](https://github.com/c4arl0s/32Blocks-ObjectiveC#3-using-blocks)
4. [x] [4. Declaring a block variable](https://github.com/c4arl0s/32Blocks-ObjectiveC#4-declaring-a-block-variable)
5. [x] [5. Assigning a block](https://github.com/c4arl0s/32Blocks-ObjectiveC#5-assigning-a-block)
6. [x] [6. Passing in a block](https://github.com/c4arl0s/32Blocks-ObjectiveC#6-passing-in-a-block)
7. [x] [7. typedef](https://github.com/c4arl0s/32Blocks-ObjectiveC#7-typedef)
8. [x] [8. Return values](https://github.com/c4arl0s/32Blocks-ObjectiveC#8-return-values)
9. [x] [9. Memory management](https://github.com/c4arl0s/32Blocks-ObjectiveC#9-memory-management)
10. [x] [10. The block-based future](https://github.com/c4arl0s/32Blocks-ObjectiveC#10-the-block-based-future)
11. [x] [11. Challenges - Anonymous block](https://github.com/c4arl0s/32Blocks-ObjectiveC#11-challenges---anonymous-block)
...
3. [x] [3. String literals](https://github.com/c4arl0s/34_C_Strings_ObjectiveC#3-string-literals)
4. [x] [4. Converting to and from NSString](https://github.com/c4arl0s/34_C_Strings_ObjectiveC#4-converting-to-and-from-nsstring)
5. [x] [5. Challenge](https://github.com/c4arl0s/34_C_Strings_ObjectiveC#5-challenge)